...
class AuthSignupHome(AuthSignupHome):
    ...
    def web_login(self, *args, **kw):
        ...
        if response.qcontext and response.qcontext.get('login', False):
            ...
            if inactive_user:
                response.qcontext.update({'message': _('Klyde is currently reviewing your trade account application.')})
        ...
        if 'error' not in response.qcontext and request.httprequest.method == 'POST':
            ...
            if get_param('auth_signup.signup_approval', 'False').lower() == 'true':
                ...
                response = request.render('web.login', {
                    'message': _("Thank you! Klyde is now processing your trade account application. You will receive an email within one business day confirming your account.")})
